...
import { createCodOrder, createPaypalOrder, capturePaypalOrder, fetchMyOrders, fetchAllOrders, updateOrderStatus } from '../thunks/orderThunks';

const orderSlice = createSlice({
  name: 'orders',
  initialState: { items: [], allOrders: [], current: null, loading: false, paymentLoading: false, error: null },
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(fetchAllOrders.fulfilled, (state, action) => { state.loading = false; state.allOrders = action.payload.orders; })
